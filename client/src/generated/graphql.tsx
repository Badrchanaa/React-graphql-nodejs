...
export type CreatePostMutation = { __typename?: 'Mutation', createPost: { __typename?: 'Post', id: number, text: string, title: string, creatorId: number } };
...
export type ForgotPasswordMutation = { __typename?: 'Mutation', resetPassword: boolean };
